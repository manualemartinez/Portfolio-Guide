...
| Project Link | Area of Analysis | Project Description | Completion Date |
|---|---|---|---|
| <img width="50" height="50" alt="image" src="https://github.com/user-attachments/assets/d79d3deb-d23c-4d1f-b2b7-c6daf520f231" /> [Costa Rican Healthcare Sector Debt Reform](https://github.com/manualemartinez/CCSS-Debt-Reform) | Data Analysis, Economics, Healthcare, History, Pensions | Created as a course project for Public Service Reform Around the World (ORGSTUDY 495). This paper discusses the inception of the Costa Rican Social Security Fund, the debates and reforms which impacted it and its interaction with other institutions of the Health sector. This paper also includes analysis on past CCSS reforms, my analysis of Panamá’s own CSS and Ministry of Health, and how failed reforms can warn about future dangers to Costa Rica. Finally, a discussion of possible reforms to these issues, that fits the current context (as of December 2025) and status quo of the system, will be presented with the goal of stabilizing the institution that has cared for millions of Costa Ricans since its inception more than 84 years ago. | September 2025 - December 2025 |
...
| Project Link | Area of Analysis | Project Description | Completion Date |
|---|---|---|---|
| 📉 [_Anti-liberacionismo_ Populist Movement (1978-1982)](https://github.com/manualemartinez/Carazo) | Economics, Elections, History, International Relations, Populism | Created as a course project for Sociology of Latin America (SOC 422). This paper covers the rise and fall from power of Rodrigo Carazo Odio, the 38th President of Costa Rica. His use of Populist messaging attacking the National Liberation Party (Partido Liberacion Nacional, PLN) played a key role in his initial victory, as well as his coalition's eventual breakdown when results did not materialize. | November 2025 - December 2025 |
